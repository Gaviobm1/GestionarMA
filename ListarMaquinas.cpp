/**************************************************
 * Módulo: ListarMaquinas.cpp
 *
 *  Este módulo permite el usuario de ver las
 *  máquinas ya introducidos
 *
...
/*==========================================
Procedimiento para crear y imprimir los
detalles de las máquinas ya introducidos
============================================*/
